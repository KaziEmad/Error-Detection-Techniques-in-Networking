...
int main()
{
    ...
    while(true)
    {
        ...
        gotoxy(24,06);
        printf("|||||||||| Error Detection Technique ||||||||||");
        gotoxy(30,10);
        ...
        case '6':
            ...
            while(another == 'y')
            {
                HummingDistance(); ///Bits Stuff and De Stuff
                printf("\nDo You Want To Use The Same Program? (y/n): ");
                fflush(stdin);
                another = getche();
                cout<<endl;
...
/**
Implementation of bit stuffing & De-stuffing.
Implementation of Character stuffing and De-stuffing.
Implementation of Parity Check Code.
Implementation of Cyclic Redundancy Code.
Write a program to implement Hamming Code.
Write a program to implement Hamming Distance
*/
